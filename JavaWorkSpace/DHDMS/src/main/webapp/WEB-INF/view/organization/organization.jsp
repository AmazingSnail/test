...
<script type="text/javascript">
    ...
    $(function() {
        organizationTreeGrid = $('#organizationTreeGrid').treegrid({
            url : '${ctxPath }/organization/treeGrid.action',
            idField : 'id',
            treeField : 'name',
            parentField : 'pid',
            fit : true,
...
//    }
    ...
    function deleteOrganizationFun(id) {
        ...
        if (node) {
            parent.$.messager.confirm('询问', '您是否要删除当前资源？删除当前资源会连同子资源一起删除!', function(b) {
                if (b) {
                    progressLoad();
                    $.post('${ctxPath }/organization/delete', {
                        id : node.id
                    }, function(result) {
                        if (result.success) {
    ...
    function editOrganizationFun(id) {
        jQuery.ajax({
            ...
            url: "${ctxPath }/organization/editPage",
            dataType: "json",
            data: {
                id: id,
            },
