...
//    	},{
      ...
      function cpmonp_export() {
          ...
          var fno = $('#cp_Fno').val();
          var state = $('input[name="cp_ColdCheck"]:checked').val();
          var url = "../${ctxPath}/ContractPlan/CpmonpExport?uyear="+uyear+"&umonth="+umonth+"&plant="+plant+"&WorkCentre="+WorkCentre+"&OrderLine="+OrderLine+"&fno="+fno+"&state="+state+"&fname="+fname+"";
