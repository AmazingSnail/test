...
<script type="text/javascript">
    ...
    $(function() {
        organizationTree = $('#organizationTree').tree({
            url : '${ctxPath }/organization/tree.action',
            parentField : 'pid',
            lines : true,
...
//                }
        ...
        roleTree= $('#userEditRoleIds').combotree({
            ...
            onLoadSuccess : function(node, data) {
                progressLoad();
                $.post( '${ctxPath }/role/findRoleIdListByUserId', {
                    id : id
                }, function(result) {
                    var ids;
...
<div class="easyui-layout" data-options="fit:true,border:false">
    ...
    <div data-options="region:'west',border:true,split:false,title:'组织机构'"  style="width:150px;overflow: hidden; overflow:scroll;">
