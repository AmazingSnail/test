...
<shiro:hasPermission name="/DealerStock/export">
                        <td><a href="#" class="easyui-linkbutton"  onclick="ds_export()" data-options="iconCls:'icon-table-go'">导出</a></td>
</shiro:hasPermission>
                        <shiro:hasPermission name="/DealerStock/export">
                    ...
                    <div class = "divmore1" style="position: absolute;z-index:1001;background-color: white" id="trt_More1">
                        <div style="margin-top: 5px">
                            ...
                            <label><span class="di2">部件特征二：</span></label><select class="easyui-combobox" name="Plant" datatype="text" id="df11" panelHeight="auto" data-options="
                            valueField:'f11',
                            textField:'f11',
                            panelHeight:'250'"
                                                                                  style="width:120px">
                        ...
                        <div style="margin-top: 5px">
                            ...
                            <label><span class="di3">连接装配方式：</span></label><select class="easyui-combobox" name="Plant" datatype="text" id="df9" panelHeight="auto" data-options="
                            valueField:'f9',
                            textField:'f9',
                            panelHeight:'250'"
                                                                                   style="width:120px">
            ...
            <div class="easyui-layout haorooms"  >
                <div id="trt_dd" class="easyui-layout cz"  data-options="fit:true">
                    <div style="width: 100%;height:100%" data-options="region:'center'">
                        <table id="ds" class="easyui-datagrid" style="white-space: nowrap;height: 100%" title="库存" data-options=""></table>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                if(data.total>0){
                                    ...
                                    $("#ds").datagrid({
                                        ...
                                        columns:[[
                                            ...
                                            {field:'maktx',title:'物料描述',width: '380px',align:'left',halign:'center'},
                                            ...
                                            {field:'f9',title:'连接装配方式',width: '100px',align:'center',halign:'center'},
