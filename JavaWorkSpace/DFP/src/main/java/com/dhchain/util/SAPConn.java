...
public class SAPConn {
    ...
    static{
        ...
        connectProperties.setProperty(DestinationDataProvider.JCO_ASHOST, "192.168.100.126");//服务器
        ...
        connectProperties.setProperty(DestinationDataProvider.JCO_USER,   "dfms");  //SAP用户名
        connectProperties.setProperty(DestinationDataProvider.JCO_PASSWD, "dfms123");     //密码
