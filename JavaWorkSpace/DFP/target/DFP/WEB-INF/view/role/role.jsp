        ...
        $(function() {
            resourceTree = $('#resourceTree').tree({
                ...
                onLoadSuccess : function(node, data) {
                    progressLoad();
                    $.post( '${ctxPath }/role/findResourceIdListByRoleId', {
                        id : id
                    }, function(result) {
                        var ids;
