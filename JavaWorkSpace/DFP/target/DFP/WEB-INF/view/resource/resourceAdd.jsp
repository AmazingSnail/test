...
<script type="text/javascript" src="../../${ctxPath }/static/ztree/js/jquery.ztree.core.js"></script>
<script type="text/javascript">
    $(function() {
        $('#resourceAddPid').combotree({
            url : '${ctxPath }/resource/allTree',
            parentField : 'pid',
            lines : true,
            panelHeight : 'auto'
        });
...
<div style="padding: 3px;">
    <form id="resourceAddForm" method="post">
        <table class="grid">
            <tr>
                <td>资源名称</td>
                <td><input name="name"  id = "resourcename" type="text" placeholder="请输入资源名称" class="easyui-validatebox span2" data-options="required:true" ></td>
                <td>资源类型</td>
                <td>
