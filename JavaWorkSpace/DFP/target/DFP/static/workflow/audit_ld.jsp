...
<table id="dg" title="批注列表" class="easyui-datagrid"
  fitColumns="true"
  url="${ctxPath }/task/listHistoryComment.do?taskId=${param.taskId}" style="width: 700px;height: 200px;">
 <thead>
 	<tr>
...
<script type="text/javascript">
    function submit(state){
        $("#fm").form("submit",{
            url:'${ctxPath }/task/audit_bz.action?state='+state,
            onSubmit:function(){
    ...
    $(function(){
        $.post("${ctxPath }/leave/getLeaveByTaskId.action",{taskId:'${param.taskId}'},function(result){
