...
<table id="dg" title="角色管理" class="easyui-datagrid"
  ...
  url="${pageContext.request.contextPath}/group/groupPage.action" fit="true" toolbar="#grpM_tb">
 <thead>
 	<tr>
...
<div id="dlg-buttons">
	<a href="javascript:void(0)" onclick="checkData()" class="easyui-linkbutton" iconCls="icon-ok">保存</a>
...
<script type="text/javascript">
    ...
    function checkData(){
        ...
        var flag=$("#flag").val();
        if(flag==1){
            $.post("${pageContext.request.contextPath}/group/existGroupName.action",{groupName:$("#id").val()},function(result){
                if(result.exist){
