...
<div class="easyui-layout" data-options="fit:true">
    <div class="easyui-panel"title="原材料使用记录" data-options="fit:true">
            ...
            <div class="wu-toolbar-search" style="white-space:nowrap">
                <table>
                    <tr><td>开始时间：<input  id ="mtdb2" style="width:100px" class="easyui-datebox">&nbsp</td>
                        ...
                        <td><label>炉批号：</label><input id="mt-reelnum" class="easyui-textbox" style="width:100px">&nbsp</td>
                    ...
                    <tr>
                        ...
                        <td><label>设备ID：</label><input id="mt-EquipID" class="easyui-textbox" style="width:100px">&nbsp</td>
                        <td><label>原料描述：</label><input id="mt-fname" class="easyui-textbox" style="width:100px">&nbsp</td>
        ...
        <div class="easyui-layout haorooms"  >
            <div class="MA" data-options="region:'west',split:true,border:true" >
                <table id="mt" class="easyui-datagrid" style="white-space: nowrap;height: 100%"  data-options="singleSelect:true"></table>
            </div>
            <div class="MC"   data-options="region:'center'" style="width:70%">
                <table class="easyui-datagrid" id="mtid" style="white-space: nowrap;height: 100%" data-options="singleSelect:true,editor:'text'" ></table>
            </div>
        </div>
    </div>
</div>
...
//                data:$("#login").val(),   //序列化
    ...
    function mt_query() {
        ...
        var fno = $('#mt-fno').val();
        var fname = $('#mt-fname').val();
        var reelnum = $('#mt-reelnum').val();
            ...
            success: function (data) {//ajax请求成功后触发的方法
                ...
                $("#mt").datagrid({
                    ...
                    columns:[[
                        ...
                        {field:'fname',title:'原料描述',width: '200px',align:'left',halign: 'center'},
                        {field:'reelnum',title:'炉批号',width: '110px',align:'center',halign:'center'},
                        {field:'weight',title:'重量',width: '80px',align:'center',halign:'center'},
                        {field:'supportName',title:'供货方',width: '150px',align:'center',halign:'center'},
                        {field:'equipID',title:'设备编号',width: '90px',align:'center',halign:'center'},
                        {field:'planID',title:'计划编号',width: '90px',align:'left',halign: 'center'},
                        {field:'productMan',title:'冲制工',width: '70px',align:'center',halign: 'center'},
                        {field:'productTime',title:'冲制时间',width: '150px',align:'center',halign: 'center'},
                        {field:'uyear',title:'年度',width: '80px',align:'center',halign:'center'},
                        {field:'umouth',title:'月度',width: '80px',align:'center',halign: 'center'},
                        {field:'over',title:'进度',width: '80px',align:'center',halign: 'center'},
        ...
        $('#mt').datagrid({
            rowStyler: function (index, row) {
                ...
                if(over>0){
                    return 'background-color:#CD2626;color:white';
                }
    ...
    $("#mt").datagrid({
        ...
        onClickRow : function (index, row) {  //easyui封装好的事件（被单机行的索引，被单击行的值）
            var coldid = row.coldID;
            $.ajax({
                type:"POST",   //post提交方式默认是get
                url:"${ctxPath}/ProductionTask/onclick.action",
                dataType:"json",
                data: {
                    coldid:coldid
                },
                success:function(data) {
                    ...
                    $('#mtid').datagrid({
                        ...
                        columns: [[
                            ...
                            {field:'weightNum',title:'重量',width: '70px',align:'left',halign: 'center'},
                            {field:'productMan',title:'操作工',width: '70px',align:'center',halign: 'center'},
                            {field:'productTime',title:'操作时间',width: '150px',align:'center',halign: 'center'},
                            {field:'weighMan',title:'称重人',width: '70px',align:'center',halign: 'center'},
                            {field:'weighTime',title:'称重时间',width: '150px',align:'right',halign: 'center'},
                            {field:'equipID',title:'设备编号',width: '90px',align:'center',halign:'center'},
                            {field:'planID',title:'计划编号',width: '90px',align:'right',halign: 'center'},
                            {field:'uyear',title:'年度',width: '80px',align:'center',halign:'center'},
                            {field:'umouth',title:'月度',width: '80px',align:'center',halign: 'center'},
                        ]],
                    })
