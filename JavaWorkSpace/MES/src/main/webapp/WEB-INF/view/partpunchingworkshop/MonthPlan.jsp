            ...
            <div class="wu-toolbar-search" style="white-space:nowrap">
                <table>
                    ...
                    <tr>
                        ...
                        <td><label class="labelstyle"><input type="radio" name="monthCheck" value="3"  checked="checked" onclick="Change()" />全部</label>
                            <label class="labelstyle"><input type="radio" name="monthCheck" value="2" onclick="Change()" />已完成</label>
                            <label class="labelstyle"><input type="radio" name="monthCheck" value="1" onclick="Change()"/>未完成</label>
                        </td>
                        <td>
                            <label class="labelstyle"><input type="radio" name="monthCheck" value="4"onclick="Change()" />已提交</label>
                            <label class="labelstyle"><input type="radio" name="monthCheck" value="5"onclick="Change()" />未提交</label>
                        </td>
...
function monp_export() {
    ...
    var name = localStorage.getItem("User");
    var state = $('input[name="monthCheck"]:checked').val();
    var url = "../${ctxPath}/Export/mpmonpExport?uyear="+uyear+"&umouth="+umouth+"&plant="+plant+"&WorkProcedure="+WorkProcedure+"&PartDrawing="+PartDrawing+"&Fno="+Fno+"&state="+state+"&PartName="+PartName+"&name=+"+name+"&fname=+"+fname+"";
