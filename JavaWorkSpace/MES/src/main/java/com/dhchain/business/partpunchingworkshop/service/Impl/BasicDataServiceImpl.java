...
public class BasicDataServiceImpl implements BasicDataService {
    ...
    @Override
    public List<BaseEquip> getListHE( BaseEquip record) {
        return baseDataMapper.getListHE(record);
    }
 ...
 @Override
    public List<BaseSupplier> getList5(BaseSupplier record) {
        return baseDataMapper.getList5(record);
    }
    ...
    @Override
    public int deleteMould(MCraftmould record) {
        return baseDataMapper.deleteMould(record);
    }
