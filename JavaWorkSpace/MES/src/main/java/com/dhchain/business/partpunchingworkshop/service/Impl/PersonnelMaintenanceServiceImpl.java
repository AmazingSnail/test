...
public class PersonnelMaintenanceServiceImpl implements PersonnelMaintenanceService {
  ...
  @Override
    public List<BaseEquip> getEquipD(BaseEquip record) {
        return personnelMaintenanceMapper.getEquipD(record);//查询设备;
    }
    ...
    @Override
    public List<EQPFault> getEquipF(EQPFault record) {
        return personnelMaintenanceMapper.getEquipF(record);
    }
