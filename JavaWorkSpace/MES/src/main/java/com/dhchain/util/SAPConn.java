...
public class SAPConn {
    ...
    static{
        ...
        connectProperties.setProperty(DestinationDataProvider.JCO_ASHOST, "172.16.0.193");//服务器
        ...
        connectProperties.setProperty(DestinationDataProvider.JCO_PASSWD, "abap123456");     //密码
