    ...
    <div class="easyui-panel"title="设备点检" data-options="fit:true">
        <div id="pttoolbar" style="overflow:auto;width:100%;height: 60px">
            ...
            <div class="wu-toolbar-search" style="white-space:nowrap">
                <table>
                    <tr><td> <label>年月：</label><input  id ="hheqmdb1" style="width:100px" class="easyui-datebox">&nbsp</td>
                        <td>事业部： <select class="easyui-combobox" name="mmPlant" style="width:100px" datatype="text" id="hhepmPlant" panelHeight="auto" data-options="
                                valueField:'Fname',
                                textField:'Fremark',
                                panelHeight:'250'"
                                         style="width:100px">
                        </select></td>
                        <td><label>设备ID：</label><select class="easyui-combobox" name="mmPlant" style="width:100px" datatype="text" id="hhqmEquipID" panelHeight="auto" data-options="
                                valueField:'EquipID',
                                textField:'EquipID',
                                panelHeight:'250'"
                                                        style="width:100px">
                        </select>&nbsp</td>
                        <td><a href="#" class="easyui-linkbutton"  onclick="hhqm_query()" data-options="iconCls:'icon-search'">查询</a></td>
                    </tr>
                </table>
            </div>
        </div>
            ...
            <div class="A" data-options="region:'west',split:true" >
                <div  class="easyui-layout" data-options="fit:true" style="width:100%;height:65%">
                    <div style="width: 100%;height:53%" data-options="region:'center'" title="设备点检(  绿圆表示完好、黄三角表示检修中、红框表示异常)">
                        ...
                        <div id="hhZT" style="height: 25px;width: auto;text-align:justify;">
                            <label style="font-size: 0.15rem;vertical-align:middle;display:inline-block;">部门：</label><span id="hhdepartment"style="width: auto;vertical-align:middle;height: 100px;font-size: 0.16rem"></span>
                            <input style="width: 8%;border: 0px;" readonly>
                            <label style="font-size:  0.15rem;vertical-align:middle;display:inline-block;">设备编号：</label><span id="hhEquipmentID" style="width: auto;height: 100px;vertical-align:middle;font-size:0.16rem"></span>
                            <input style="width: 8%;border: 0px;" readonly>
                            <label style="font-size:  0.15rem;vertical-align:middle;display:inline-block;">设备名称：</label><span id="hhEquipmentName" style="width: auto;height: 100px;vertical-align:middle;font-size: 0.16rem"></span>
                            <input style="width: 8%;border: 0px;" readonly>
                            <label style="font-size:  0.15rem;;vertical-align:middle;display:inline-block;">设备型号：</label><span id="hhEquipmentSize" style="width: auto;height: 100px;vertical-align:middle;font-size:0.16rem"></span>
                            <input style="width: 8%;border: 0px;" readonly>
                            <label style="font-size:  0.15rem;vertical-align:middle;display:inline-block;">设备员：</label><span id="hhEquipmentpersonnel" style="width: auto;height: 100px;vertical-align:middle;font-size: 0.16rem"></span>
                        </div>
                        <table id="hheqm" class="easyui-datagrid" style="white-space: nowrap;height: 90%"  data-options="singleSelect:true"></table>
                    </div>
                </div>
            </div>
        </div>
        ...
        $("#hhepmPlant").combobox({
            ...
            onChange: function () {
                jQuery.ajax({
                    ...
                    dataType: "json",
                    data: {
                        plant:  $('#hhepmPlant').combobox('getValue')+"4"
                    },
//                data:$("#login").val(),   //序列化
                    ...
                    success: function (data) {
                        console.log(data);
                        $('#hhqmEquipID').combobox('loadData', data);
                    }
                });
            }
        });
...
//                data:$("#login").val(),   //序列化
            ...
            success: function (data) {
                $('#hhepmPlant').combobox('loadData', data);
                //alert(11111);
    ...
    function hhqm_query() {
        ...
        var d = 0;
        var e = 0;
        var uyear = $('#hheqmdb1').val().substr(0,4);;
        var umouth  = $('#hheqmdb1').val().substr(5);
        var EquipID = $('#hhqmEquipID').combobox('getValue');
        var fdata;
        if(EquipID!=""){
            $.ajax({
                ...
                success: function (data) {//ajax请求成功后触发的方法
                    ...
                    $('#hheqm').datagrid({loadFilter: CZRK_pagerFilter}).datagrid('loadData', fdata);
                    document.getElementById("hhdepartment").innerHTML = a;
                    document.getElementById("hhEquipmentID").innerHTML = b;
                    document.getElementById("hhEquipmentName").innerHTML = c;
                    document.getElementById("hhEquipmentSize").innerHTML = d;
                    document.getElementById("hhEquipmentpersonnel").innerHTML = e;
                },
            ...
            $('#hheqm').datagrid('loadData',{total:0,rows:[]});
        }  else {
