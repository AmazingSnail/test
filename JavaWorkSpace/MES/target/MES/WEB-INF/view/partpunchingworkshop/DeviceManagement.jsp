...
<shiro:hasPermission name="/DeviceManagement/reflash">
                            ...
                            <td align="center">
                                <label style="font-size: 20px;margin-left: 500px;">当前时间：</label> <a id="divBottom" style="width: auto;height: 50px;vertical-align:middle;font-size: 20px;text-align: right"></a></td>
                        </tr>
                    </table>
            ...
            <div class="easyui-layout haorooms"  >
                <div class="Z" data-options="region:'west',split:true" >
                    <div  class="easyui-layout" data-options="fit:true" style="width:100%;height:65%">
                        <br>
                        <label><span class="m3">事业部：</span></label>
                        <select class="easyui-combobox" name="mmPlant" style="width:100px" datatype="text" id="dmPlant" panelHeight="auto" data-options="
                                valueField:'plant',
                                textField:'plant',
                                panelHeight:'250'"
                                style="width:100px">
                ...
                <div class="X"  data-options="region:'east',split:true" style="text-align: left" >
                    ...
                    <div id="ZT" style="height: 20px;width: auto;text-align:justify;">
                        <label style="font-size: 18px;vertical-align:middle;display:inline-block;">总台数：</label><span id="zts"style="width: auto;vertical-align:middle;height: 100px;font-size: 20px;">0</span>&nbsp&nbsp&nbsp
                        <label style="font-size: 18px;vertical-align:middle;display:inline-block;">运行：</label><span id="yx" style="width: auto;height: 100px;vertical-align:middle;font-size: 20px">0</span>&nbsp&nbsp&nbsp
                        <label style="font-size: 18px;vertical-align:middle;display:inline-block;">停机：</label><span id="tj" style="width: auto;height: 100px;vertical-align:middle;font-size: 20px">0</span>&nbsp&nbsp&nbsp
                        <label style="font-size: 18px;vertical-align:middle;display:inline-block;">关机：</label><span id="gj" style="width: auto;height: 100px;vertical-align:middle;font-size: 20px">0</span>&nbsp&nbsp&nbsp
                        <label style="font-size: 18px;vertical-align:middle;display:inline-block;"> 故障：</label><span id="gz" style="width: auto;height: 100px;vertical-align:middle;font-size: 20px">0</span>&nbsp&nbsp&nbsp
                        <label style="font-size: 18px;vertical-align:middle;display:inline-block;">未知：</label><span id="wz" style="width: auto;height: 100px;vertical-align:middle;font-size: 20px">0</span>&nbsp&nbsp&nbsp
                        <label style="font-size: 18px;vertical-align:middle;display:inline-block;">未启用：</label><span id="wqy" style="width: auto;height: 100px;vertical-align:middle;font-size: 20px">0</span>&nbsp&nbsp&nbsp
                    </div>
                    <hr />
                     <div id="shebei" style="width: 1000px">
...
<script type="text/javascript">
    ...
    function reflash() {
        if(i=='零件车间'){
            ...
            document.getElementById('shebei').innerHTML='';
            jQuery.ajax({
                type: "POST",   //post提交方式默认是get
                url:'${ctxPath }/DeviceManagement/DeviceInfo.action',
                dataType: "json",
                data: {
                    plant : $('#dmPlant').combobox('getText'),
                    department:  i,
                    year:year,
                    month:month,
                },
                ...
                success: function (data) {
                    ...
                    var s  = data[0].total;
                    console.log(num);
                    var noApplicationRecord = document.getElementById('shebei');
                    var html='';
                    var a =0;
                    var b ='';
                    var c ='';
    ...
    function date1()
    {
        ...
        document.getElementById("divBottom").innerHTML=year+"年"+month+"月"+day+"日"+" "+hour+":"+minute+":"+second+" ";
    }
...
//                data:$("#login").val(),   //序列化
            ...
            success: function (data) {
                $('#dmPlant').combobox('loadData', data);
                //alert(11111);
...
//树形结构
        //加载全部节点
        $("#tree_menu").tree({
            url: '${ctxPath }/DeviceManagement/query?param1='+localStorage.getItem("Department"),
            queryParams: { },
    ...
    $("#dmPlant").combobox({
        onChange: function (n,o) {
            $("#tree_menu").tree({
                url: '${ctxPath }/DeviceManagement/query?param1='+n,
                queryParams: { },
                onBeforeExpand:function(node,param){
