            ...
            <div class="wu-toolbar-search" style="white-space:nowrap">
                <table>
                    ...
                    <tr>
                        ...
                        <td> <label>设备编号： </label>
                            <select class="easyui-combobox" name="mmPlant" style="width:100px" datatype="text" id="emEquipID" panelHeight="auto" data-options="
                                valueField:'EquipID',
                                textField:'EquipID',
                                panelHeight:'250'"
                                    style="width:100px">
            ...
            <div class="A" data-options="region:'west',split:true" >
                <div  class="easyui-layout" data-options="fit:true" style="width:100%;height:65%">
                    <div style="width: 100%;height:53%" data-options="region:'center'">
                        <table id="em" class="easyui-datagrid" style="white-space: nowrap;height: 100%"  title="故障明细（检修状态：绿色:检修完成，浅绿色：已完成,
...
//        });
        jQuery.ajax({
            ...
            url:'${ctxPath }/PersonnelMaintenance/selectDeviceF.action',
            dataType: "json",
            data: {
...
//                data:$("#login").val(),   //序列化
            ...
            success: function (data) {
                console.log(data);
                $('#emEquipID').combobox('loadData', data);
            }
        });
        jQuery.ajax({
            type: "POST",   //post提交方式默认是get
...
//                data:$("#login").val(),   //序列化
            ...
            success: function (data) {
                ...
                edepartment =  $('#emdepartment').combobox('getValue');
            }
        });
        jQuery.ajax({
            type: "POST",   //post提交方式默认是get
...
//
    ...
    function emquery() {
        ...
        var EquipID = $('#emEquipID').combobox('getValue')
        var starttime = $('#emdb1').datebox('getValue');
        var endtime = $('#emdb').datebox('getValue');
        var fdata;
        if(edepartment==''||edepartment == department){
            $.ajax({
