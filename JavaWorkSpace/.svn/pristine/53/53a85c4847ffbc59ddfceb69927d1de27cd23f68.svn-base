...
//                dataType: "json",
//                data: {
//                    warehouse: $("#userAddRoleIds").val(),
//                },
//                success: function (data) {
//                    console.log(data);
//                    for (var i = 0; i < data.length; i++) {
//                        $("#userAddRoleIds").append("<option>" + data[i].text + "</option>");
//                    }
//                }
//            });
//        });
...
//         $('#userAddRoleIds').combobox({
//             onChange: function() {
//                 var obj=document.getElementById("userAddRoleIds");
//                 console.log(obj.getText);
//
//////                       var value = $('#userAddRoleIds').combobox('getKey');
////                 var options=$("#userAddRoleIds option:selected");//获取当前选择项.
////
    ...
    <div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;">
        <form id="userAddForm" method="post">
            <table class="grid">
                ...
                <tr>
                    <td>部门</td>
                    <td><select id="userAddOrganizationId" name="organizationId" style="width: 140px; height: 29px;" class="easyui-combobox" data-options="required:true"></select></td>
                    <td>角色</td>
