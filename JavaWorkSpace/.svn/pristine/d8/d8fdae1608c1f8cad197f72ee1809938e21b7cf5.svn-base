            ...
            <div class="A" data-options="region:'west',split:true" >
                <div  class="easyui-layout" data-options="fit:true" style="width:100%;height:65%">
                    <div style="width: 100%;height:53%" data-options="region:'center'" title="设备点检(  绿圆表示完好、黄三角表示检修中、红框表示异常)">
                        ...
                        <div id="ZT" style="height: 25px;width: auto;text-align:justify;">
                        ...
                        <table id="eqm" class="easyui-datagrid" style="white-space: nowrap;height: 90%"  data-options="singleSelect:true"></table>
                    </div>
                </div>
            </div>
        </div>
        ...
        $("#epmPlant").combobox({
            ...
            onChange: function () {
                jQuery.ajax({
                    ...
                    dataType: "json",
                    data: {
                        plant:  $('#epmPlant').combobox('getValue')+"3"
                    },
//                data:$("#login").val(),   //序列化
