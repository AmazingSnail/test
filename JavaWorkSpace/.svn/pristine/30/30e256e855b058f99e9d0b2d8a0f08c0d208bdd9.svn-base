...
<head>
    ...
    <link rel="icon" type="image/png" href="/MES/static/login/favicon.png">
    <meta name="mobile-web-app-capable" content="yes">
    <!-- Safari浏览器添加到主屏幕（IOS） -->
    <link rel="icon" sizes="192x192" href="/MES/static/login/apple-touch-icon.png">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="black">
    <meta name="apple-mobile-web-app-title" content="HMDM">
    <!-- Win8标题栏及ICON图标 -->
    <link rel="apple-touch-icon-precomposed" href="/MES/static/login/apple-touch-icon.png">
    <meta name="msapplication-TileImage" content="http://cdn.admui.com/demo/pjax/1.2.0/images/app-icon72x72@2x.png">
    <meta name="msapplication-TileColor" content="#62a8ea">
    <!-- 样式 -->
    <link rel="stylesheet" href="/MES/static/login/bootstrap.css">
    <link rel="stylesheet" href="/MES/static/login/site.css" id="siteStyle">
    ...
    <!-- 自定义 -->
    <link rel="stylesheet" href="/MES/static/login/login.css">
    <!-- 插件 -->
    <link rel="stylesheet" href="/MES/static/login/animsition.css">
    <!-- 图标 -->
    <link rel="stylesheet" href="/MES/static/login/web-icons.css">
    <link rel="stylesheet" href="/MES/static/login/images/login.jpg">
    <link rel="stylesheet" href="/MES/static/login/font-awesome.css">
    <!-- 插件 -->
    <link rel="stylesheet" href="/MES/static/login/bootstrap-select.css">
    <link rel="stylesheet" href="/MES/static/login/formValidation.css">
    <script type="text/javascript" src="/MES/static/js/jquery-1.8.0.min.js"></script>
    <script type="text/javascript" src="/MES/static/js/ajaxfileupload.js"></script>
    <script type="text/javascript" src="/MES/static/js/jquery.form.js"></script>
    <script type="text/javascript" src="/MES/static/js/extJs.js"></script>
    <script type="text/javascript" src="/MES/static/js/ext/adapter/ext/ext-base.js"></script>
    <script type="text/javascript" src="/MES/static/js/ext/ext-all.js"></script>
    <script type="text/javascript" src="/MES/static/css/1.5.2/jquery.easyui.min.js"></script>
    <script type="text/javascript" sr c="/MES/static/css/1.5.2/locale/easyui-lang-zh_CN.js"></script>
    <!-- 百度统计 -->
    <script>
        var _hmt = _hmt || [];
        (function() {
    ...
    <!-- 客服组件 -->
    <%--<script src="/MES/static/login/main.js  "  charset="UTF-8" id="kf5-provide-supportBox" kf5-domain="admui.kf5.com"></script>--%>
</head>
    ...
    <div class="page-content height-full">
        <div class="page-brand-info vertical-align animation-slide-left hidden-xs">
            <div class="page-brand vertical-align-middle">
                <div class="brand">
                    <%--<img class="brand-img" src="/MES/static/css/icons/dhlogo.png" height="50" alt="HMDM">--%>
                </div>
                <h2 class="hidden-sm">智能制造物联网系统</h2>
        ...
        <div class="page-login-main animation-fade">
            ...
            <div class="vertical-align">
                <div class="vertical-align-middle">
                    ...
                    <p class="hidden-xs">MES 智能制造物联网系统</p>
...
<script src="/MES/static/login/jquery.js"></script>
<script src="/MES/static/login/bootstrap.js"></script>
<script src="/MES/static/login/bootstrap-select.min.js"></script>
<script src="/MES/static/login/formValidation.min.js" data-name="formValidation"></script>
<script src="/MES/static/login/bootstrap.min.js" data-deps="formValidation"></script>
