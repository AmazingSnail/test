            ...
            <div class="wu-toolbar-search" style="white-space:nowrap">
                <table>
                    ...
                    <tr>
                        ...
                        <td><label>设备编号：</label><input  id ="ed-EquipID" style="width:100px" class="easyui-textbox"></td>
                        <td><label class="labelstyle"><input type="radio" name="edCheck" value="3" checked />全部</label>
                            <label class="labelstyle"><input type="radio" name="edCheck" value="1" />已称重</label>
                            <label class="labelstyle"><input type="radio" name="edCheck" value="2" />未称重</label></td>
                    </tr>
                </table>
            </div>
...
function edexport() {
    ...
    var starttime = $('#eddb1').datebox('getValue');
    var endtime = $('#eddb2').datebox('getValue');
    var url = "../${ctxPath}/ElementDetail/Export?uyear="+uyear+"&umouth="+umouth+"&plant="+plant+"&planID="+planID+"&fno="+fno+"&reelnum="+reelnum+"&state="+state+"&equipID="+equipID+"&partDrawing=+"
